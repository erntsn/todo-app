...
const TodoItem = ({ todo, onToggle, onRemove, onTagClick, language, translations, onOpen }) => {
    const categoryBadgeClasses = {
        work: 'bg-blue-700 text-blue-200',
        personal: 'bg-purple-700 text-purple-200',
        health: 'bg-green-700 text-green-200',
        shopping: 'bg-pink-700 text-pink-200',
        finance: 'bg-yellow-700 text-yellow-200',
    ...
    return (
        ...
        >
            <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                    ...
                    <div className="flex flex-wrap items-center gap-2 mt-1.5 text-xs text-gray-300">
                        {todo.category && (
                            <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs ${categoryBadgeClasses[todo.category] || categoryBadgeClasses.other}`}>
            ...
            <button
                className="ml-2 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-red-500/20 text-red-400 hover:bg-red-500/30 hover:text-red-500 transition-colors"
                onClick={(e) => {
                    e.stopPropagation();
                    onRemove(todo.id);
                }}
